...
use App\Http\Controllers\Frontend\BulkOrderController;
...
//Route::get('/is-featured', [ProductController::class, 'isFeatured'])->name('products.is_featured');
...
# parfait customizer
Route::get('/build-your-parfait', [App\Http\Controllers\Frontend\ParfaitController::class, 'index'])->name('parfait.builder');
// Route::get('/build-your-parfait', function() { return "Route Works (Controller Bypassed)"; });
Route::post('/build-your-parfait/add', [App\Http\Controllers\Frontend\ParfaitController::class, 'addToCart'])->name('parfait.addToCart');

# bulk order
Route::get('/bulk-order', [BulkOrderController::class, 'index'])->name('bulk-order.index');
Route::post('/bulk-order/add-to-cart', [BulkOrderController::class, 'bulkAddToCart'])->name('bulk-order.addToCart');

# events
Route::get('/events', [App\Http\Controllers\Frontend\EventsController::class, 'index'])->name('events.index');
Route::post('/events/submit', [App\Http\Controllers\Frontend\EventsController::class, 'store'])->name('events.store');
