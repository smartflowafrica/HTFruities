...
class BannerSectionFiveController extends Controller
{
    ...
    {
        $banners = [];
        if (getSetting('organic_banner_section_five_banners') != null) {
            $banners = json_decode(getSetting('organic_banner_section_five_banners'));
        }
        return $banners;
    }
    ...
    public function index()
    {
        ...
        return view('backend.pages.appearance.organic.homepage.bannerSectionFive', compact('banners'));
    }

    # banner section five
    public function storeBannerFive(Request $request)
    {
        $bannerImage = SystemSetting::where('entity', 'organic_banner_section_five_banners')->first();
        if (!is_null($bannerImage)) {
            ...
            $bannerImage->entity = 'organic_banner_section_five_banners';
    ...
    {
        $banners = $this->getBanners();
        return view('backend.pages.appearance.organic.homepage.bannerSectionFiveEdit', compact('banners', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.appearance.organic.homepage.bannerFive');
    }
