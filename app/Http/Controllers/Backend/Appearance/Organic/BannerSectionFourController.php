...
class BannerSectionFourController extends Controller
{
    ...
    {
        $banners = [];
        if (getSetting('organic_banner_section_four_banners') != null) {
            $banners = json_decode(getSetting('organic_banner_section_four_banners'));
        }
        return $banners;
    }
    ...
    public function index()
    {
        ...
        return view('backend.pages.appearance.organic.homepage.bannerSectionFour', compact('banners'));
    }

    # banner section Four
    public function storeBannerFour(Request $request)
    {
        $bannerImage = SystemSetting::where('entity', 'organic_banner_section_four_banners')->first();
        if (!is_null($bannerImage)) {
            ...
            $bannerImage->entity = 'organic_banner_section_four_banners';
    ...
    {
        $banners = $this->getBanners();
        return view('backend.pages.appearance.organic.homepage.bannerSectionFourEdit', compact('banners', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.appearance.organic.homepage.bannerFour');
    }
