...
class BannerSectionThreeController extends Controller
{
    ...
    private function getBanners()
    {
        ...
        if (getSetting('furniture_banner_section_three_banners') != null) {
            $banners = json_decode(getSetting('furniture_banner_section_three_banners'));
        }
        return $banners;
    }
    ...
    public function index()
    {
        ...
        return view('backend.pages.appearance.furniture.homepage.bannerSectionThree', compact('banners'));
    }

    # banner section two
    public function storeBannerThree(Request $request)
    {
        $bannerImage = SystemSetting::where('entity', 'furniture_banner_section_three_banners')->first();
        if (!is_null($bannerImage)) {
            ...
            $bannerImage->entity = 'furniture_banner_section_three_banners';
    ...
    {
        $banners = $this->getBanners();
        return view('backend.pages.appearance.furniture.homepage.bannerSectionThreeEdit', compact('banners', 'id'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.appearance.furniture.homepage.bannerThree');
    }
