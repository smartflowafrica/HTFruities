        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    ...
                    <form action="{{ route('admin.appearance.furniture.homepage.updateBannerTwo') }}" method="POST"
                            ...
                            <div class="card-body">
                                 <div class="mb-4">
                                    ...
                                    <input type="text" name="title" id="title"
                                        placeholder="{{ localize('Banner Title') }}" class="form-control"
                                        value="{{ $banner->title }}">
                                </div>
                                <div class="mb-4">
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">{{ localize('Banner Section Two') }}</h5>
