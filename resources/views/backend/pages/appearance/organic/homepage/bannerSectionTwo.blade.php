        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                                    ...
                                                    <div class="dropdown tt-tb-dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.appearance.organic.homepage.editBannerTwo', ['id' => $banner->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                                <i data-feather="edit-3"
                                                                    class="me-2"></i>{{ localize('Edit') }}
                                                            </a>

                                                            <a href="#" class="dropdown-item confirm-delete"
                                                                data-href="{{ route('admin.appearance.organic.homepage.deleteBannerTwo', $banner->id) }}"
                    ...
                    <form action="{{ route('admin.appearance.organic.homepage.storeBannerTwo') }}" method="POST"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" id="title" placeholder="{{ localize('Banner Title') }}"
                                        class="form-control" required>
                                </div>
                                <div class="mb-4">
                                    <label for="subtitle" class="form-label">{{ localize('Subtitle') }}</label>
                                    <input type="text" name="subtitle" id="subtitle"
                                        placeholder="{{ localize('Banner Subtitle') }}" class="form-control">
                                </div>
                                <div class="mb-4">
