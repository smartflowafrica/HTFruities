        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    ...
                    <form action="{{ route('admin.appearance.organic.homepage.updateBannerOne') }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" id="title"
                                        placeholder="{{ localize('Enter Banner Title') }}" class="form-control"
                                        value="{{ $banner->title ?? ''}}">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="subtitle" id="subtitle"
                                        placeholder="{{ localize('Enter Banner Subtitle') }}" class="form-control"
