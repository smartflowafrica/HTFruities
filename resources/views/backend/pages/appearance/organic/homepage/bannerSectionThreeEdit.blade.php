        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    ...
                    <form action="{{ route('admin.appearance.organic.homepage.updateBannerThree') }}" method="POST"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="text" id="text" class="form-control">{{ $banner->text ?? '' }}</textarea>
                                </div>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">{{ localize('Banner Section Three') }}</h5>
