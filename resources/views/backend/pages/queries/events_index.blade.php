...
@section('title')
    {{ localize('Event Inquiries') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Event Inquiries') }}</h2>
                            </div>
                            <div class="tt-action">
                                <button type="button" class="tt-remove btn btn-soft-danger d-flex align-items-center"
                                    ...
                                    data-href="{{ route('admin.events.queries.deleteAll') }}" onclick="confirmAllDelete(this)"><i
                            ...
                            <tbody>
                                @foreach ($messages as $key => $message)
                                    <tr class="{{ $message->is_seen == 0 ? 'fw-bold' : 'fw-light' }}">
                                        ...
                                        <td>
                                            {{ str_replace('Event Inquiry: ', '', $message->message) }}
                                        </td>
                                            ...
                                            <div class="dropdown tt-tb-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    <a href="#" class="dropdown-item confirm-delete"
                                                        data-href="{{ route('admin.events.queries.delete', [$message->id, 'clear']) }}"
