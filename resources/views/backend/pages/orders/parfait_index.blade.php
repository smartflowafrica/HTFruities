...
@section('title')
    {{ localize('Build Your Parfait Order') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Build Your Parfait Order') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table tt-footable border-top align-middle" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-breakpoints="xs">{{ localize('Custom Ingredients') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach($order->orderItems as $item)
                                                @if($item->product_variation->product->slug == 'custom-parfait')
                                                    <div class="fs-sm text-primary">
                                                        <strong>{{ $item->product_variation->product->collectLocalization('name') }}</strong>
                                                        <br>
