...
@section('title')
    {{ localize('Bulk Orders') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Bulk Orders') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach ($orders as $key => $order)
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            ...
                                            <span class="badge bg-soft-info rounded-pill ms-2">{{ localize('Bulk') }}</span>
                                        </td>
