...
<body>
    ...
    <div id="preloader">
        <img src="{{ getSetting('frontend_preloader') ? uploadedAsset(getSetting('frontend_preloader')) : staticAsset('frontend/default/assets/img/preloader.gif') }}" alt="preloader" class="img-fluid" max-width="180">
    </div>
    @endif
    <!--preloader end-->
