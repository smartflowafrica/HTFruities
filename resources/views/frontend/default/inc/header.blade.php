                    ...
                    <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative">
                        ...
                        <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                            <ul class="d-flex align-itmes-center justify-content-end">
                                ...
                                @endif
                                    <li><a href="{{ route('parfait.builder') }}" class="text-primary fw-bold">{{ localize('Build Your Parfait') }}</a></li>
                                    <li><a href="{{ route('bulk-order.index') }}">{{ localize('Bulk Order') }}</a></li>
<li><a href="{{ route('events.index') }}">{{ localize('Events') }}</a></li>
